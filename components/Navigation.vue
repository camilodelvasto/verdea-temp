    ...
    >
      ...
      >
        ...
        >
          ...
          <nuxt-link target="_blank" to="tel:3107730336" class="navbar-item">Tel: 310 773 0336</nuxt-link>

        </div>
        <div class="navbar-end"
          v-on:click="closeMobileMenu()"
        >
          <nuxt-link to="//facebook.com/verdeaonline" class="navbar-item" target="_blank">
          ...
          <nuxt-link to="//api.whatsapp.com/send?phone=3107730336" class="navbar-item" target="_blank">
            <svg style="width:28px;height:28px" viewBox="0 0 24 24">
